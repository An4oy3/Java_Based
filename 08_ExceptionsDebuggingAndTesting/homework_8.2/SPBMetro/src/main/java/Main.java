...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        loggerInfo = LogManager.getLogger("InfoLogger");
        loggerInputError = LogManager.getLogger("InputErrorsLogger");
        loggerException = LogManager.getLogger("ExceptionLogger");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                loggerInfo.info("Введена станция: " + line);
                return station;
            }
            loggerInputError.debug("Станция не найдена: " + line);
